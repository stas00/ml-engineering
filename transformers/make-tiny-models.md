...
**Unless you're testing the quality of the model, always use a tiny random model with potentially tiny tokenizer.**
...
The following are quite similar to each other:
