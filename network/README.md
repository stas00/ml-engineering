...
And we measured our compute to be 0.42 secs, so here we have a problem as `0.42 > 0.053` so the compute will be slower than communication and the forward/backward is the bottleneck.
